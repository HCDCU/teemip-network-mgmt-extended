...
Dict::Add('ES CR', 'Spanish', 'Español, Castellano', array(
	'Class:IPInterface/Attribute:interfacespeed_id' => 'Velocidad',
	'Class:IPInterface/Attribute:interfacespeed_id+' => '',
	'Class:IPInterface/Attribute:layer2protocol_id' => 'Protocolo',
	'Class:IPInterface/Attribute:layer2protocol_id+' => 'Protocolo de capa 2',
));
...
Dict::Add('ES CR', 'Spanish', 'Español, Castellano', array(
	...
	'Class:AggregateLink:baseinfo' => 'Información General',
...
Dict::Add('ES CR', 'Spanish', 'Español, Castellano', array(
	'Class:VLAN:baseinfo' => 'Información General',
	'Class:VLAN/Attribute:vlan_tag' => 'Etiqueta',
	'Class:VLAN/Attribute:vlan_tag+' => 'Integer value only',
	'Class:VLAN/Attribute:name' => 'Nombre',
...
Dict::Add('ES CR', 'Spanish', 'Español, Castellano', array(
	'Menu:NetworkMgmtExtended:Typology' => 'Configuración de Topología de Red',
));
